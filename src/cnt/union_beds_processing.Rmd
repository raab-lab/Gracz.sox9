...
process_bed_files <- function(neg_bed_path, pos_bed_path, output_dir) {
  ...
  output_path <- file.path(output_dir, 'union_sox9_ac.bed')
...
```{r assign obj}
neg_bed_path <- "/Users/jbrink/Downloads/Sox9N_H3K27ac_ConsensusPeaks.bed"
pos_bed_path <- "/Users/jbrink/Downloads/Sox9P_H3K27ac_ConsensusPeaks.bed"
